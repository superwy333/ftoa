...
public class ActivitiController extends BaseController {
    ...
    @ResponseBody
    public JsonUtil uploadModel(MultipartFile file, HttpServletRequest request, HttpServletResponse response, HttpSession session) throws IllegalStateException, IOException{
        if (file!=null) {

            InputStream input = new FileInputStream(mutiPart2File(file));
...
//        }
    ...
    private File mutiPart2File(MultipartFile file) {
